...
function DescriptionsPro(props) {
    var data = props.data, other = __rest(props, ["data"]);
    return (React.createElement("div", { className: "descriptions-pro" }, data.length > 0 ? React.createElement(antd.Descriptions, __assign({}, other), data.map(function (item, index) {
